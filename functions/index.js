...
// スケジュール設定で毎日19:15に定期実行
exports.getRatioFromSiteAndSet = functions.region('asia-northeast1').runWith({ memory: '1GB' }).pubsub.schedule('15 19 * * *').timeZone('Asia/Tokyo').onRun(async (context) => {
